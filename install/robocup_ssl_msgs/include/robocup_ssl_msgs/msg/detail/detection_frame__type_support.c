...
#include <stddef.h>
#include "robocup_ssl_msgs/msg/detail/detection_frame__rosidl_typesupport_introspection_c.h"
...
#include "robocup_ssl_msgs/msg/detail/detection_frame__struct.h"


// Include directives for member types
// Member `balls`
#include "robocup_ssl_msgs/msg/detection_ball.h"
// Member `balls`
#include "robocup_ssl_msgs/msg/detail/detection_ball__rosidl_typesupport_introspection_c.h"
// Member `robots_yellow`
// Member `robots_blue`
#include "robocup_ssl_msgs/msg/detection_robot.h"
// Member `robots_yellow`
// Member `robots_blue`
#include "robocup_ssl_msgs/msg/detail/detection_robot__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  robocup_ssl_msgs__msg__DetectionFrame__init(message_memory);
}

void DetectionFrame__rosidl_typesupport_introspection_c__DetectionFrame_fini_function(void * message_memory)
{
  robocup_ssl_msgs__msg__DetectionFrame__fini(message_memory);
}

size_t DetectionFrame__rosidl_typesupport_introspection_c__size_function__DetectionBall__balls(
  const void * untyped_member)
{
  const robocup_ssl_msgs__msg__DetectionBall__Sequence * member =
    (const robocup_ssl_msgs__msg__DetectionBall__Sequence *)(untyped_member);
  return member->size;
}
...
{
  robocup_ssl_msgs__msg__DetectionBall__Sequence * member =
    (robocup_ssl_msgs__msg__DetectionBall__Sequence *)(untyped_member);
  return &member->data[index];
}
  ...
  void * untyped_member, size_t size)
{
  robocup_ssl_msgs__msg__DetectionBall__Sequence * member =
    (robocup_ssl_msgs__msg__DetectionBall__Sequence *)(untyped_member);
  robocup_ssl_msgs__msg__DetectionBall__Sequence__fini(member);
  return robocup_ssl_msgs__msg__DetectionBall__Sequence__init(member, size);
}

size_t DetectionFrame__rosidl_typesupport_introspection_c__size_function__DetectionRobot__robots_yellow(
  const void * untyped_member)
{
  const robocup_ssl_msgs__msg__DetectionRobot__Sequence * member =
    (const robocup_ssl_msgs__msg__DetectionRobot__Sequence *)(untyped_member);
  return member->size;
}
...
void * DetectionFrame__rosidl_typesupport_introspection_c__get_function__DetectionRobot__robots_yellow(
  void * untyped_member, size_t index)
{
  robocup_ssl_msgs__msg__DetectionRobot__Sequence * member =
    (robocup_ssl_msgs__msg__DetectionRobot__Sequence *)(untyped_member);
  return &member->data[index];
}
  ...
  void * untyped_member, size_t size)
{
  robocup_ssl_msgs__msg__DetectionRobot__Sequence * member =
    (robocup_ssl_msgs__msg__DetectionRobot__Sequence *)(untyped_member);
  robocup_ssl_msgs__msg__DetectionRobot__Sequence__fini(member);
  return robocup_ssl_msgs__msg__DetectionRobot__Sequence__init(member, size);
}
...
static rosidl_typesupport_introspection_c__MessageMember DetectionFrame__rosidl_typesupport_introspection_c__DetectionFrame_message_member_array[7] = {
  {
    "frame_number",  // name
    ...
    offsetof(robocup_ssl_msgs__msg__DetectionFrame, frame_number),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robocup_ssl_msgs__msg__DetectionFrame, t_capture),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robocup_ssl_msgs__msg__DetectionFrame, t_sent),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robocup_ssl_msgs__msg__DetectionFrame, camera_id),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robocup_ssl_msgs__msg__DetectionFrame, balls),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robocup_ssl_msgs__msg__DetectionFrame, robots_yellow),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robocup_ssl_msgs__msg__DetectionFrame, robots_blue),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers DetectionFrame__rosidl_typesupport_introspection_c__DetectionFrame_message_members = {
  ...
  7,  // number of fields
  sizeof(robocup_ssl_msgs__msg__DetectionFrame),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robocup_ssl_msgs, msg, DetectionFrame)() {
  DetectionFrame__rosidl_typesupport_introspection_c__DetectionFrame_message_member_array[4].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robocup_ssl_msgs, msg, DetectionBall)();
  DetectionFrame__rosidl_typesupport_introspection_c__DetectionFrame_message_member_array[5].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robocup_ssl_msgs, msg, DetectionRobot)();
