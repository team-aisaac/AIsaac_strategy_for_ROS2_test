...
#ifndef ROBOCUP_SSL_MSGS__MSG__DETAIL__COMMANDS__FUNCTIONS_H_
#define ROBOCUP_SSL_MSGS__MSG__DETAIL__COMMANDS__FUNCTIONS_H_
 ...
 * calls
 * robocup_ssl_msgs__msg__Commands__init().
...
/**
 * It calls
 * robocup_ssl_msgs__msg__Commands__fini()
 ...
 * robocup_ssl_msgs__msg__Commands__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * robocup_ssl_msgs__msg__Commands__Sequence__fini()
 * on the array,
...
#endif  // ROBOCUP_SSL_MSGS__MSG__DETAIL__COMMANDS__FUNCTIONS_H_
