  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  robocup_ssl_msgs__msg__DetectionBall__init(message_memory);
}

void DetectionBall__rosidl_typesupport_introspection_c__DetectionBall_fini_function(void * message_memory)
{
  robocup_ssl_msgs__msg__DetectionBall__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember DetectionBall__rosidl_typesupport_introspection_c__DetectionBall_message_member_array[7] = {
  {
    ...
    offsetof(robocup_ssl_msgs__msg__DetectionBall, confidence),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(robocup_ssl_msgs__msg__DetectionBall, area),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robocup_ssl_msgs__msg__DetectionBall, x),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robocup_ssl_msgs__msg__DetectionBall, y),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(robocup_ssl_msgs__msg__DetectionBall, z),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robocup_ssl_msgs__msg__DetectionBall, pixel_x),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robocup_ssl_msgs__msg__DetectionBall, pixel_y),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers DetectionBall__rosidl_typesupport_introspection_c__DetectionBall_message_members = {
  ...
  7,  // number of fields
  sizeof(robocup_ssl_msgs__msg__DetectionBall),
