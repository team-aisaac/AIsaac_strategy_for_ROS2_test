...
#ifndef ROBOCUP_SSL_MSGS__MSG__DETAIL__ROBOT_STATUS__FUNCTIONS_H_
#define ROBOCUP_SSL_MSGS__MSG__DETAIL__ROBOT_STATUS__FUNCTIONS_H_
 ...
 * calls
 * robocup_ssl_msgs__msg__RobotStatus__init().
...
/**
 * It calls
 * robocup_ssl_msgs__msg__RobotStatus__fini()
 ...
 * robocup_ssl_msgs__msg__RobotStatus__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * robocup_ssl_msgs__msg__RobotStatus__Sequence__fini()
 * on the array,
...
#endif  // ROBOCUP_SSL_MSGS__MSG__DETAIL__ROBOT_STATUS__FUNCTIONS_H_
