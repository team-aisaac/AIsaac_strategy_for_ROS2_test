...
{
  new (message_memory) robocup_ssl_msgs::msg::DetectionFrame(_init);
}

void DetectionFrame_fini_function(void * message_memory)
{
  auto typed_message = static_cast<robocup_ssl_msgs::msg::DetectionFrame *>(message_memory);
  typed_message->~DetectionFrame();
}

size_t size_function__DetectionFrame__balls(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<robocup_ssl_msgs::msg::DetectionBall> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<robocup_ssl_msgs::msg::DetectionBall> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<robocup_ssl_msgs::msg::DetectionBall> *>(untyped_member);
  return &member[index];
}
...
{
  const auto * member = reinterpret_cast<const std::vector<robocup_ssl_msgs::msg::DetectionRobot> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<robocup_ssl_msgs::msg::DetectionRobot> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<robocup_ssl_msgs::msg::DetectionRobot> *>(untyped_member);
  return &member[index];
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember DetectionFrame_message_member_array[7] = {
  {
    "frame_number",  // name
    ...
    offsetof(robocup_ssl_msgs::msg::DetectionFrame, frame_number),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robocup_ssl_msgs::msg::DetectionFrame, t_capture),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robocup_ssl_msgs::msg::DetectionFrame, t_sent),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robocup_ssl_msgs::msg::DetectionFrame, camera_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<robocup_ssl_msgs::msg::DetectionBall>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(robocup_ssl_msgs::msg::DetectionFrame, balls),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<robocup_ssl_msgs::msg::DetectionRobot>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(robocup_ssl_msgs::msg::DetectionFrame, robots_yellow),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robocup_ssl_msgs::msg::DetectionFrame, robots_blue),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers DetectionFrame_message_members = {
  ...
  7,  // number of fields
  sizeof(robocup_ssl_msgs::msg::DetectionFrame),
...
get_message_type_support_handle<robocup_ssl_msgs::msg::DetectionFrame>()
{
  return &::robocup_ssl_msgs::msg::rosidl_typesupport_introspection_cpp::DetectionFrame_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robocup_ssl_msgs, msg, DetectionFrame)() {
  return &::robocup_ssl_msgs::msg::rosidl_typesupport_introspection_cpp::DetectionFrame_message_type_support_handle;
}
